function clearAll() {
  ...
  function showRiddle() {
    ...
    questionElem.textContent = randomRiddle.question;
    
    const answerElem = document.createElement('p');
    answerElem.textContent = 'The answer is: ' + randomRiddle.answer;
  ...
  function revealAnswers() {
    const riddleContainer = document.querySelector('.content-container');
    const riddle = riddleContainer.querySelector('p');
    answer = document.querySelector('#riddle-answer');
    if (riddle && answer.hidden) {
      answer.hidden = false;
    } else if (riddle) {
      alert('The answer is already revealed')
    } else {
      alert('There is no riddle to reveal the answer to!. Click the "riddle me" button to show a riddle')
    }
  }
